...
\hypersetup{
  pdftitle={THESIS TITLE: SOME CATCHY LINE},
  pdfauthor={WHAT'S YOUR NAME},
  hidelinks,
...
\textbf{THESIS TITLE: SOME CATCHY LINE}
...
{\centering \includegraphics[width=0.7\linewidth]{UNR-thesis-template_files/figure-latex/rplot-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{UNR-thesis-template_files/figure-latex/ggplot-1} 
