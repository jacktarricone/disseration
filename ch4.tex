...
MODIS also produced the greatest SWE loss ($-$19.09~hm$^{3}$), with Landsat again providing a low value of $-$12.87~hm$^{3}$. IMS, MODSCAG, VIIRS, and FLM again provided consistent estimates, with the standard deviation of these five data products SWE loss being only 0.35~hm$^{3}$. Landsat's SWE loss was 5.81~hm$^{3}$ greater when compared to the five other data products mean SWE loss of $-$18.68~hm$^{3}$. This is a percent difference of 36.80~\%.

\begin{figure}[t]
\centering
\label{fig:dswe_bar_graph}
\includegraphics[width=10cm]{figures/ch4_figs/dswe_stats_new_v10.png}
