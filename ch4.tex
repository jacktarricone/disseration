...
\midrule
Native ground range pixel spacing & 80\,m \\
...
%==============================================================================
\hypertarget{ch4-methods}{\section{Methods}\label{ch4-methods}}
\hypertarget{ch4-methods}{\subsection{InSAR $\Delta$SWE}\label{ch4-methods}}


We employ the InSAR $\Delta$SWE methodology described in Section \ref{ch3-methods-1}. Using \ref{} To find the  known change point to tether the initially relative InSAR values, we used three snow pillows (names here) from CADWR. To account for uncertainties within the snow pillow geolocation, we extracted the UAVSAR pixel that station was within and the eith surrounding pixels.
