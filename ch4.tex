...
Snowpack information was collected at two pit locations in the UAVSAR Sierra flight line during the SnowEx 2020 campaign. One was dug near the US Army Corps of Engineers Cold Regions Research and Engineering Laboratory (CRREL) and the University of California, Santa Barbara (UCSB) joint “CUES” snow study on Mammoth Mountain (37.6432533, $-$119.0290694) \citep{bairCUESStudySite2015}, the other Near Panorama Dome  (37.6196618,	$-$119.0002711). $\rho_\mathrm{s}$ were measured in 10\,cm increments starting at the top of the pit. In situ $\rho_\mathrm{s}$ measurements have been shown to have an uncertainty of $\sim$\,10\,\% \citep{congerComparisonDensityCutters2009, prokschIntercomparisonSnowDensity2016}. Unlike the in situ data used in \cite{tarriconeEstimatingSnowAccumulation2023a}, there were no direct in situ values of permittivity.
