...
\hypertarget{ch5-discussion-1}{\section{Key findings and future directions}\label{ch4-discussion}}
...
-line from bair about large pixel sizes effecting total area
 \cite{bairHowTradeoffsSatellite2023}
