...
\hypertarget{ch4-methods-3}{\subsection{IMS}\label{ch4-methods-3}}
...
\hypertarget{ch4-methods-4}{\subsection{MODSCAG}\label{ch4-methods-4}}
\hypertarget{ch4-methods-5}{\subsection{MODIS}\label{ch4-methods-5}}
\hypertarget{ch4-methods-6}{\subsection{VIIRS}\label{ch4-methods-6}}
\hypertarget{ch4-methods-7}{\subsection{FLM}\label{ch4-methods-7}}

The fused Landsat-MODIS (FLM) product created by \cite{rittgerMultisensorFusionUsing2021}

\hypertarget{ch4-methods-8}{\subsection{Landsat fSCA}\label{ch4-methods-8}}

Landsat~8 fSCA \citep{u.s.geologicalsurveyearthresourcesobservationandsciencecenterCollection1LandsatLevel32018} data from 4~March 2020 (Fig.~4.2e). These data are generated using a spectral unmixing analysis based on the Snow Covered Area and Grain size (SCAG) algorithm developed for MODIS (Painter et al., 2009). The data processing workflow includes water masking, cloud masking, and canopy cover corrections \citep{selkowitzUSGSLandsatSnow2017, stillingerLandsatMODISVIIRS2023a}. 
...
\hypertarget{ch4-methods-3}{\subsection{FLM}\label{ch4-methods-3}}
