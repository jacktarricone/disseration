...
\hypertarget{ch3-methods-5}{\subsection{Description of the study area}\label{ch3-methods-5}}
...
%f3
\begin{figure*}[t]
\includegraphics[width=14cm]{tc-2022-224-f03.jpg}
...
%t02
\begin{table*}[t]
\caption{UAVSAR unwrapped phase (UNW) and coherence statistics for the full scene (FS) and study area (SA). UNW loss (\%) is the percentage of pixels lost in the unwrapping process.}
\begin{tabular}{l l l l l l}
\tophline
Pair & Polarization & FS mean coherence & SA mean coherence & FS UNW loss (\%) & SA UNW loss (\%) \\
\middlehline
