...
SWE data from 29 SNOTEL from sites (black dots in Fig.~\ref{kuy_study_area}a) between 1985--2016, totaling $\sim$840 station years, were used for snow metric validation. Operated by the United States Department of Agriculture's Natural Resources Conservation Service (NRCS), it is a comprehensive network of remote, long-term, automated snowpack and climate measurement sites spread across the western United States and Alaska. These data are quality controlled by the NRCS and are freely available.
