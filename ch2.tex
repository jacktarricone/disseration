...
We used snow pillow data from 29 SNOTEL sites totaling $\sim$840 station years (Fig. \ref{}(**UPDATE map with SNOTEL LOCATIONS AND ASPECTS). Operated by the United States Department of Agriculture's Natural Resources Conservation Service (NRCS), it is a comprehensive network of remote, long-term, automated sites spread across the western United States and Alaska. These data are quality controlled by the NRCS.
